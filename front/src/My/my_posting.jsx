...
const Empty = () => {
  ...
  const fetchPosts = async () => { //user가 작성한 글 정보 가져오는 api요청
    axios
      ...
      .catch((err) => {
        console.log('나의 게시글 페이지 접근 요청 할때 catch된 에러', err.messsage);
          ...
          axios
            ...
            .then((response) => {
              if (response.status === 200) {
                ...
                console.log('잘 됬으니까 다시 전체 게시글로 넘어가기');
                return navigate('/my/posting');
